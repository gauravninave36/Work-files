...
form.addEventListener("submit", function (e) {
  //prevent default cause usually form submit data into  the server and dont hold em ..ie its only for split of seconds 
  e.preventDefault();
  const value = parseInt(amount.value);
  console.log(value);//black color for string and blue color for numbers gotcha
  console.log(isNaN(value));
  //Possible cases of values that can be thrown paragraph box 
  //emptyvalue
  //-1
  //>9
